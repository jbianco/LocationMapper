...
public class LocationDbAdapter {
	...
	private static final String DATABASE_CREATE = "create table locations (_id integer primary key autoincrement, "
			+ "name text not null, latitude real not null, longitude real not null, speed real not null, accuracy integer not null, time integer not null);";
	...
	/**
	 * Add new location. If the location is successfully created return the new
	...
	public long addLocation(Location location) {
		...
		contentValues.put(KEY_SPEED, location.getSpeed());
